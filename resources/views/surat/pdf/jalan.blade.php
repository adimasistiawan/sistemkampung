...
@endif
      ...
      <div style="padding-right: 30px">
        ...
        <div style="padding-left: 30px">
          ...
          <p>Nama tersebut diatas benar penduduk Kampung Notoharjo Kecamatan Trimurjo Kabupaten Lampung Tengah yang selama ini dalam pengawasan kami dan beradat istiadat baik.</p>
          <p>TUJUAN :</p>
      <div style="padding-right: 30px"> 
          <div style="padding-left: 30px">
          <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td width="395px">{{$data->keperluan}}</td>
            </tr>
            <tr>
                <td>Berangkat Tanggal</td>
                <td>:</td>
                <td>{{date('d-m-Y',strtotime($data->berangkat_tanggal))}}</td>
              </tr>
          </table>
        </div>
