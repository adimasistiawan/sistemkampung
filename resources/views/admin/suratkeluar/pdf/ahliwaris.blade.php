...
<body>
  @if ($watermark)
  <div style="background-size: cover; background-repeat: no-repeat; background-image: url({{asset('belum_dierima.png')}});">
@else
  <div>
@endif
      <div style="text-align: center; ">
        ...
        <u><span style=" font-size:19px;">SURAT KETERANGAN AHLI WARIS</span></u><br>
        ...
        <div style="padding-left: 30px">
          <table>
            ...
            <tr>
              ...
              <td>:</td>
              <td width="395px">{{$warga->nama}} dsfsdfsdfs dsfdsgdfgdf dsd.</td>
            </tr>
            <tr>
